...
//    val temp_joinDf1 = joinDf.groupBy("rectangle").count().orderBy("rectangle")
//    joinDf.groupBy("rectangle").count().orderBy("rectangle")
//    temp_joinDf1.show()
//    print(temp_joinDf1.)
//    println("")
...
//    joinDf.createOrReplaceTempView("joinResult")
    ...
    return joinDf.coalesce(1) // YOU NEED TO CHANGE THIS PART
  }
